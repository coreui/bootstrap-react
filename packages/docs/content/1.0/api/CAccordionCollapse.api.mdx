...
```jsx
import { CAccordionCollapse } from '@coreui/bootstrap-react'
// or
import CAccordionCollapse from '@coreui/bootstrap-react/src/components/accordion/CAccordionCollapse'
```
