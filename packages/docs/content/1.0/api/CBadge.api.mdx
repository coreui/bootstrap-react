...
// or
import CBadge from '@coreui/bootstrap-react/src/components/badge/CBadge'
```
...
| **textColor** | Sets the text color of the component to one of Bootstrap React’s themed colors. | `'primary'` \| `'secondary'` \| `'success'` \| `'danger'` \| `'warning'` \| `'info'` \| `'dark'` \| `'light'` \| `'white'` \| `'white-50'` \| `'muted'` \| `'black-50'` \| `'body'` \| `string` | - |
