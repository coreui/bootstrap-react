---
title:  Form Controls
name: Bootstrap React Form control
description: Bootstrap React input and textarea components. Give textual form controls like `<input>`s and `<textarea>`s an upgrade with custom styles, sizing, focus states, and more.
menu: Forms
