...
name: Bootstrap React Carousel
description: Bootstrap React Carousel is a slideshow component for cycling through elements—images or slides of text—like a carousel.
menu: Components
