...
name: Bootstrap React Dropdown
description: Bootstrap React Dropdown component allows you to toggle contextual overlays for displaying lists, links, and more html elements.
menu: Components
...
<Callout color="info">
  <h4>RTL</h4>
  <p>
    Directions are mirrored when using Bootstrap React in RTL, meaning `.dropstart` will appear on the right
    side.
  </p>
</Callout>
