...
name: Bootstrap React Spinner
description: Indicate the loading state of a component or page with Bootstrap React Spinners, built entirely with HTML, CSS, and no JavaScript.
menu: Components
route: /components/spinner
---

import { CSpinner, CButton } from '@coreui/bootstrap-react/src/index'
