...
name: Bootstrap React Placeholder
description: Use loading Bootstrap React Placeholders for your components or pages to indicate something may still be loading. 
menu: Components
