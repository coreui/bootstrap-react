...
name: Bootstrap React Breadcrumb
description: Bootstrap React Breadcrumb navigation component which indicates the current location within a navigational hierarchy that automatically adds separators.

menu: Components
route: /components/breadcrumb
---

import { CBreadcrumb, CBreadcrumbItem } from '@coreui/bootstrap-react/src/index'
