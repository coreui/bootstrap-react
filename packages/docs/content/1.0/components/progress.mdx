...
name: Bootstrap React Progress
description: Documentation and examples for using Bootstrap React Progress bars featuring support for stacked bars, animated backgrounds, and text labels.

menu: Components
route: /components/progress
---

import { CProgress, CProgressBar, CButton } from '@coreui/bootstrap-react/src/index'
