...
name: Bootstrap React Badge
description: Bootstrap React badge component is small count and labeling component.

menu: Components
route: /components/badge
---

import { CBadge, CButton } from '@coreui/bootstrap-react/src/index'
