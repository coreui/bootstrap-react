...
name: Bootstrap React Offcanvas
description: Bootstrap React Offcanvas component allows build hidden sidebars into your project for navigation, shopping carts.
menu: Components
...
<COffcanvas backdrop={false} placement="start" portal={false} visible={true}>
  ...
  <COffcanvasBody>
    Content for the offcanvas goes here. You can place just about any Bootstrap React component or custom
    elements here.
  </COffcanvasBody>
</COffcanvas>
```
