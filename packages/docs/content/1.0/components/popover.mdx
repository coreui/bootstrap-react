...
name: Bootstrap React Popover
description: Documentation and examples for adding Bootstrap React Popovers, like those found in iOS, to any element on your site.

menu: Components
route: /components/popover
---

import { CPopover, CButton } from '@coreui/bootstrap-react/src/index'
