...
name: Bootstrap React Navbar
description: Documentation and examples for the Bootstrap React Navbar powerful, responsive navigation header component. Includes support for branding, links, dropdowns, and more.
...
Immediate child elements of `<CNavbar>` use flex layout and will default to `justify-content: space-between`. Use additional [flex utilities](https://getbootstrap.com/docs/5.1/utilities/flex/) as needed to adjust this behavior.
